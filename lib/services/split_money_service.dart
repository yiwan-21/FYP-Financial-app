...
class SplitMoneyService {
  ...
  static Future<SplitExpense> getExpenseByID(String expenseID) async {
    ...
    DocumentReference expenseDoc = groupsCollection.doc(_groupID).collection('expenses').doc(expenseID);
  ...
  static Future<void> deleteGroup() async {
    return await groupsCollection.doc(_groupID).delete();
  }
  ...
  static Future<void> deleteExpense(String expenseID ) async {
    await groupsCollection.doc(_groupID).collection('expenses').doc(expenseID).delete();
  }
